<?php
	...
	if(!$cg = sqlValue("select count(1) from membership_groups where allowSignup=1")){
		...
		<?php include("$currDir/footer.php"); ?>		<?php
		exit;
	}
